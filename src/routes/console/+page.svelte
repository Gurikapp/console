...
const lines = [
	...
	{
		type: 'info',
		content: '<span class="tag">[06:00 – 12:00] QUEST_ISSUED:</span> Игроки дали задание NPC: Кузнец. Время выполнения: 1 временной эпизод.'
	},
	{
		type: 'info',
	...
	{
		type: 'dialogue-fail',
		content: '<span class="tag">[18:00 – 00:00] WARNING:</span> NPC «<span class="npc">Кассадор</span>» убит NPC: Страж_повелителя_людей_7 и NPC: Страж_повелителя_людей_8.'
	},
	{
		type: 'dialogue-fail',
	...
	{
		type: 'info',
		content: '<span class="tag">[06:00 – 12:00] MINIGAME:</span> Пройдена мини-игра "Ханойская башня". Уровень сложности: 2. Репутация: «<span class="highlight-cyan">Лагерь Магов</span>» -2.'
	},
	...
	{
		type: 'info',
		content: '<span class="tag">[00:00 – 05:00] DIALOGUE:</span> Игроки «<span class="highlight">Эд</span>», «<span class="highlight">Зереф</span>», «<span class="highlight">Сыр</span>» вступили в диалог с NPC: Пенелопа.'
	},
	{
		type: 'dialogue-fail',
		content: '<span class="tag">[00:00 – 05:00] WARNING:</span> Игрок «<span class="highlight">Сыр</span>» умер от болевого шока и был принудительно отключён от симуляции.'
	},
	{
		type: 'dialogue-fail',
		content: '<span class="tag">[00:00 – 05:00] WARNING:</span> Игрок «<span class="highlight">Эд</span>» умер от болевого шока и был принудительно отключён от симуляции.'
	},
	{
		type: 'zone',
	...
	{
		type: 'dialogue-fail',
		content: '<span class="tag">[05:00 – 06:00] WARNING:</span> Игрок «<span class="highlight">Зереф</span>» был раздавлен внезапно возникшим метеоритом и был отключён от симуляции.'
	},
	{ type: 'separator', content: '--------------------------------------------------------------------' },
	{
		type: 'system',
